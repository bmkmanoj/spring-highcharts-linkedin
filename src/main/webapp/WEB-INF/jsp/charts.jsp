...
<html lang="en">
<head>
    <title>LinkedIn Data Dashboard</title>
...
<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <a href="<c:url value='/charts'/>" class="navbar-brand"><small>LinkedIn Data from Manoj's Profile</small></a>
            ...
            <div class="col-md-9">
                <div class="panel panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">Friends Located Cities</h3>
                    </div>
                    <div id="chart1-container" style="min-width: 600px; max-width: 800px;  height: 600px; margin: 0 auto"></div>
                </div>
            </div>
            <div class="col-md-9">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Friends Working Companies</h3>
                    </div>
                    <div id="chart2-container" style="min-width: 600px; max-width: 800px;  height: 600px; margin: 0 auto"></div>
                </div>
            </div>
            <div class="col-md-9">
                <div class="panel panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title">Friends Subscribed Groups</h3>
                    </div>
                    <div id="chart3-container" style="min-width: 600px; max-width: 800px;  height: 600px; margin: 0 auto"></div>
                </div>
            </div>
        </div>
    </div>
